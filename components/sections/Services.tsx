import { HeartHandshake, ShoppingBag, Sparkles, Gem } from "lucide-react";
        ...
        {SERVICES.map(({ description, icon, title }) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="mt-6 font-display text-2xl text-brand-secondary">
                {title}
              </h3>
              <p className="mt-3 leading-7 text-brand-secondary/60">
                {description}
              </p>
            </article>
          );
